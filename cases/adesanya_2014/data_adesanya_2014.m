...
% This model exhibited an outflow of iCit due to it being a dead end.
...
reactorGeometry = 'adesanya_2014';

%% Models & Methods
NumIntervals = 20; % Number of light invervals (10-15 active recommended)
...
% Liquid phase
totalX0 = 0.1959; % g/L
N0 = 0.124/14*1000/6; % mmol/L
lipidContent0 = 0.02; % g/gDW
starchContent0 = 0.02; % g/gDW
