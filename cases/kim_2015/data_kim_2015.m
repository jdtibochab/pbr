...
% sizeIncrease = 1.7827;
% maxOxygenDemand = 9.0997;
% maxCarbonUptake = -4.1342;
% K = 0.0330; % Half saturation coefficient for starch consumption
% qh = 0.0988; % Half saturation coefficient for lipid ratio (m-m model only);
