...
%% Fixes
modelLight = addReaction(modelLight,'ICITht','reactionFormula','akg_c + icit_h  <=> akg_h + icit_c');
modelLight = changeRxnBounds(modelLight,'ICITht',0,'b');

modelDark = addReaction(modelDark,'ICITht','reactionFormula','akg_c + icit_h  <=> akg_h + icit_c');
...
experimentalDataset = 'lv_2010_1N';
% experimentalDataset = 'lv_2010_0.2N';
% experimentalDataset = 'lv_2010_3N';
% experimentalDataset = 'lv_2010_5N';
...
reactorGeometry = 'lv_2010';

%% Models & Methods
NumIntervals = 25; % Number of light invervals (10-15 active recommended)
...
nitrogenSource = nitrogenSources{1};
...
totalX0 = 0.0641; % g/L
N0 = 0.9661; % mmol/L
lipidContent0 = 0.18; % g/gDW
starchContent0 = 0.13; % g/gDW
