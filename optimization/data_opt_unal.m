...
% initialIntI0 = 80;
% finalIntI0 = 80;
internalLightStrategy = 'undefined';
...
modelLight.ub(lightSourceID) = 100000; % Open the limit for optimization
...
[intI0profile,lightCondProfile] = lightProfile(tspan,initialIntI0,finalIntI0,internalLightStrategy,lightp,b); % uE/m2-s;
[extI0profile,lightCondProfile] = lightProfile(tspan,initialExtI0,finalExtI0,externalLightStrategy,lightp,b); % uE/m2s;
